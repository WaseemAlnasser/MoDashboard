    ...
    <div class="dashboard-body">
        <div class="row justify-content-center">
            <div class="contactus-form">
                <div class="col-lg-12">
                    <form action="{{route('user.service.place')}}" method="post">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control form--control" name="gateway" required>
                                ...
                                <option value="balance">@lang('Account Balance') {{ $general->cur_sym
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" step="any" name="amount" class="form-control form--control"
                                    value="{{ $service->price }}" autocomplete="off" readonly>
